...
class GoalEvent(AbstractEvent): 
    def __init__(self, 
                ...
                team_actor: Team):
        """
            A class to represent a Goal Event in the match

            goal_event(match: Match,  cicles: tuple[int, int], players_left: list[Agent2D], players_right: list[Agent2D], team_actor: Team)
