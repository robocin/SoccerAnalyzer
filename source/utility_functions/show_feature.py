...
def show_feature(item_text, MainWindow, game_data):
    ...
    elif(item_text == "Fouls Proportion"):
        FoulsProportion.fouls_proportion(MainWindow, game_data)

    elif(item_text == "Fouls Position"):
        FoulsPosition.fouls_position(MainWindow, game_data)

    elif(item_text == "Goals Position"):
        GoalsPosition.goals_position(MainWindow, game_data)

    elif(item_text == "Goal Replay"):
        GoalReplay.goal_replay(MainWindow, game_data)

    elif(item_text == "Player Replay"):
        PlayerReplay.player_replay(MainWindow, game_data)

    elif(item_text == "Heatmaps"):
